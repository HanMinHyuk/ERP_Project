		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cl3syncyoungpppureqpurreqapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungpppureqpurreqapproval-display": {
								"semanticObject": "cl3syncyoungpppureqpurreqapproval",
								"action": "display",
								"description": "UI5 Purchase request approval",
								"title": "Purchase request approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.pp.pureq.purreqapproval",
									"url": sap.ui.require.toUrl("cl3/syncyoung/pp/pureq/purreqapproval")
								}
							}
						}
					}
