		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Plan order list",
									"targetURL": "#cl3syncyoungppporderplanorderlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungppporderplanorderlist-display": {
								"semanticObject": "cl3syncyoungppporderplanorderlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.pp.porder.planorderlist",
									"url": sap.ui.require.toUrl("cl3/syncyoung/pp/porder/planorderlist")
								}
							}
						}
					}
